...
Usage:
    uv run python genesis_scene_build/aggregate_datasets.py \
        --dataset-root genesis_scene_build/datasets/banana_pick_50ep \
        --dataset-root genesis_scene_build/datasets/lemon_pick_50ep \
        --dataset-root genesis_scene_build/datasets/plum_pick_50ep \
        --out genesis_scene_build/datasets/fruit_pick_150ep
...
def main() -> None:
    ...
    if info_path.is_file():
        ...
        print(
            "[next] train with:\n"
            f"       uv run python genesis_scene_build/train_policy.py act "
