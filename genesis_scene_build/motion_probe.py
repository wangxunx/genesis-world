...
Usage:
    uv run python genesis_scene_build/motion_probe.py --pick 011_banana
    uv run python genesis_scene_build/motion_probe.py --pick 011_banana 018_plum
"""
...
def main() -> None:
    ...
    out_dir = Path(args.out_dir) if args.out_dir else _ROOT / "eval_results" / "motion_probe"
